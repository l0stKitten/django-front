...
export default function Menu(props) {
	...
	return (
		...
		<AppBarCC position={'relative'} openVar={open} cannotOpen={cannotOpen} handleDrawerOpen={handleDrawerOpen} username={props.username} points={props.points} avatar={props.avatar} sx={{ml: 1}}/>
